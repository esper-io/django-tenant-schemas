...
class TenantTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.tenant.save(verbosity=0, using="default")  # todo: is there any way to get the verbosity from the test command here?
...
class FastTenantTestCase(TenantTestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            cls.tenant.save(verbosity=0, using="default")
